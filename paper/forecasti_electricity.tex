...
\geometry{left=2cm, top=2cm, right=2cm, bottom=2cm, footskip=1cm}
...
\begingroup
\obeylines
\input{../python/tables/naive_arima_performance.txt}%
\endgroup%
...
\begingroup
\obeylines
\input{../python/tables/featured_arima_performance.txt}%
\endgroup%
